class TermLookup < BasePage
  ...
  action(:search) { |b| b.frm.button(text: "Search").click; loading.wait_while_present }
  action(:clear_values) { |b| b.frm.button(text: "clear values").click; loading.wait_while_present }
